...
public abstract class RiskMetrics implements java.io.Serializable {
  ...
  public VeryHighToVeryLowEnum getScore_weight() {
    // if (score_weight == null) {
    // score_weight = VeryHighToVeryLowEnum.UNKNOWN;
    // return score_weight;
    // }
    return score_weight;
  }
  ...
  public void setScore_weight(VeryHighToVeryLowEnum score_weight) {
    ...
    // if (score_weight == null) {
    // this.score_weight = VeryHighToVeryLowEnum.UNKNOWN;
    // }
  }

  public VeryHighToVeryLowEnum getAccess_vector_weight() {
    // if (access_vector_weight == null) {
    // access_vector_weight = VeryHighToVeryLowEnum.UNKNOWN;
  ...
  public void setAccess_vector_weight(VeryHighToVeryLowEnum access_vector_weight) {
    ...
    // if (access_vector_weight == null) {
    // this.access_vector_weight = VeryHighToVeryLowEnum.UNKNOWN;
    // }
  }

  public VeryHighToVeryLowEnum getAccess_complexity_weight() {
    // if (access_complexity_weight == null) {
    // access_complexity_weight = VeryHighToVeryLowEnum.UNKNOWN;
  ...
  public void setAccess_complexity_weight(
    ...
    // if (access_complexity_weight == null) {
    // this.access_complexity_weight = VeryHighToVeryLowEnum.UNKNOWN;
    // }
  }

  public VeryHighToVeryLowEnum getAuthentication_weight() {
    // if (authentication_weight == null) {
    // authentication_weight = VeryHighToVeryLowEnum.UNKNOWN;
  ...
  public void setAuthentication_weight(
    ...
    // if (authentication_weight == null) {
    // this.authentication_weight = VeryHighToVeryLowEnum.UNKNOWN;
    // }
  }

  public VeryHighToVeryLowEnum getConfidentiality_impact_weight() {
    // if (confidentiality_impact_weight == null) {
    // confidentiality_impact_weight = VeryHighToVeryLowEnum.UNKNOWN;
  ...
  public void setConfidentiality_impact_weight(
    ...
    // if (confidentiality_impact_weight == null) {
    // this.confidentiality_impact_weight = VeryHighToVeryLowEnum.UNKNOWN;
    // }
  }

  public VeryHighToVeryLowEnum getIntegrity_impact_weight() {
    // if (integrity_impact_weight == null) {
    // integrity_impact_weight = VeryHighToVeryLowEnum.UNKNOWN;
  ...
  public void setIntegrity_impact_weight(
    ...
    // if (integrity_impact_weight == null) {
    // this.integrity_impact_weight = VeryHighToVeryLowEnum.UNKNOWN;
    // }
  }

  public VeryHighToVeryLowEnum getAvailability_impact_weight() {
    // if (availability_impact_weight == null) {
    // availability_impact_weight = VeryHighToVeryLowEnum.UNKNOWN;
  ...
  public void setAvailability_impact_weight(
    ...
    // if (availability_impact_weight == null) {
    // this.availability_impact_weight = VeryHighToVeryLowEnum.UNKNOWN;
    // }
  }

  public VeryHighToVeryLowEnum getLast_modified_date_weight() {
    // if (last_modified_date_weight == null) {
    // last_modified_date_weight = VeryHighToVeryLowEnum.UNKNOWN;
  ...
  public void setLast_modified_date_weight(
    ...
    // if (last_modified_date_weight == null) {
    // this.last_modified_date_weight = VeryHighToVeryLowEnum.UNKNOWN;
    // }
  }
