...
var ProductResultsStore = Ext.create('Ext.data.JsonStore', {
	...
	data: [
	  ...
	  {product_name: 'Baltimore', version: '2015', latitude: '39.277821', longitude: '-76.622790', product_state: 'active'},
	  {product_name: 'San Francisco', version: '2015', latitude: '37.402661', longitude: '-121.970103', product_state: 'active'},
	  {product_name: 'Denver', version: '2015', latitude: '39.743478', longitude: '-105.020814', product_state: 'active'}
	]
});